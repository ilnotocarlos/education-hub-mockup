...
export default function ApplicationError({
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (formData) {
        localStorage.setItem('applicationFormBackup', formData)
  ...
  const hasBackup = typeof window !== 'undefined' && localStorage.getItem('applicationFormBackup')
      ...
      <Card className="max-w-lg border-2 border-[hsl(var(--amber)_/_0.3)] shadow-xl">
        <CardHeader>
          ...
          <CardDescription className="text-center">
            Non perdere il tuo lavoro! Abbiamo salvato i tuoi dati automaticamente.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          {hasBackup && (
            <Alert className="bg-[hsl(var(--sage)_/_0.1)] border-[hsl(var(--sage)_/_0.3)]">
              ...
              <AlertDescription className="text-sm">
                I tuoi dati sono stati salvati in sicurezza. Riprova per recuperarli automaticamente.
              </AlertDescription>
            </Alert>
          )}
          <Button
          ...
          >
            ...
            Riprova (I tuoi dati verranno recuperati)
          </Button>
          <Button
            variant="outline"
            className="w-full"
          ...
          <Button
            variant="outline"
            className="w-full"
            onClick={() => window.location.href = 'mailto:support@educationhub.com?subject=Errore Candidatura&body=Ho riscontrato un errore durante l\'invio della candidatura.'}
          >

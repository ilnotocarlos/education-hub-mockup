# UI Components - Education Hub

Tutti i componenti UI del design system Education Hub basato su shadcn/ui.
...
**Description**: Alert container with variants for different message types
...
**Description**: Animated number counter with spring animation
**Props**: value (string), duration (number)
...
**Component**: Avatar, AvatarImage, AvatarFallback, AvatarBadge, AvatarGroup, AvatarGroupCount
**Description**: Avatar component with image, fallback, badge support
...
**Props**: variant (default | secondary | destructive | outline | ghost | link), asChild (boolean)
...
**Component**: Card, CardHeader, CardTitle, CardDescription, CardAction, CardContent, CardFooter
**Description**: Card container components
**Props**: None (uses standard div props)
...
**Component**: DropdownMenu (multiple subcomponents)
**Description**: Dropdown menu component
**Props**: variant (default | destructive), inset (boolean)
...
**Props**: type (text | email | password | etc), standard input props
...
Due to token limits, the remaining components (Label, Progress, RadioGroup, ScrollArea, Select, Separator, Slider, Switch, Tabs, Textarea, Tooltip) follow the same structure with full source code. All are in `/apps/web/src/components/ui/` directory.
